      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        {posts.length === 0 ? (
          ...
          <div className="space-y-12">
            ...
            {featuredPost && (
              <section>
                <div className="group relative block overflow-hidden rounded-3xl bg-white border border-slate-200/80 shadow-xs hover:shadow-xl transition-all duration-300">
                  <div className="grid grid-cols-1 lg:grid-cols-12 gap-0">
                    
                    {/* Cover Image Link */}
                    <Link 
                      href={`/blog/${featuredPost.slug}`}
                      className="relative lg:col-span-7 h-64 sm:h-80 lg:h-[420px] bg-slate-100 overflow-hidden block"
                    >
                    ...
                    <div className="lg:col-span-5 p-6 sm:p-8 lg:p-10 flex flex-col justify-between">
                      ...
                      <div className="pt-6 mt-6 border-t border-slate-100 flex items-center justify-between">
                        ...
                        <Link 
                          href={`/blog/${featuredPost.slug}`}
                          className="inline-flex items-center gap-1 text-xs font-bold text-[#5F021F] group-hover:translate-x-1 transition-transform"
                        >
                  ...
                  {gridPosts.map((post) => (
                    ...
                    >
                      ...
                      <div className="p-5 pt-0 flex items-center justify-between text-xs text-slate-500 font-medium">
                        ...
                        <Link 
                          href={`/blog/${post.slug}`}
                          className="font-bold text-[#5F021F] inline-flex items-center gap-0.5 group-hover:translate-x-0.5 transition-transform"
                        >
