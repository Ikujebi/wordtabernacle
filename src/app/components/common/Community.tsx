    ...
    <div className="grid grid-cols-1 md:grid-cols-3 w-full gap-0 overflow-hidden bg-zinc-950">
      ...
      <section className="relative group h-[32rem] sm:h-[35rem] md:h-[40rem] w-full overflow-hidden border-b md:border-b-0 md:border-r border-zinc-900/30">
        ...
        <div className="absolute inset-0 p-8 flex flex-col justify-end items-center text-center z-20 pb-16">
          ...
          <Link 
            href="/contact" 
            className="w-full max-w-[200px] h-12 bg-white hover:bg-red-600 text-zinc-950 hover:text-white text-xs font-bold tracking-widest uppercase rounded flex items-center justify-center transition-all duration-300 transform group-hover:translate-y-[-2px] shadow-xl"
          >
            JOIN US
          </Link>
        </div>
      ...
      <section className="relative group h-[32rem] sm:h-[35rem] md:h-[40rem] w-full overflow-hidden border-b md:border-b-0 md:border-r border-zinc-900/30">
        ...
        <div className="absolute inset-0 p-8 flex flex-col justify-end items-center text-center z-20 pb-16">
          ...
          <Link 
            href="/leadership" 
            className="w-full max-w-[200px] h-12 bg-red-600 hover:bg-red-700 text-white text-xs font-bold tracking-widest uppercase rounded flex items-center justify-center transition-all duration-300 transform group-hover:translate-y-[-2px] shadow-xl shadow-red-900/20"
          >
            START HERE
          </Link>
        </div>
      ...
      <section className="relative group h-[32rem] sm:h-[35rem] md:h-[40rem] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 p-8 flex flex-col justify-end items-center text-center z-20 pb-16">
          ...
          <Link 
            href="/prayer" 
            className="w-full max-w-[200px] h-12 bg-zinc-900/90 backdrop-blur-sm hover:bg-white text-white hover:text-zinc-950 border border-zinc-800 hover:border-white text-xs font-bold tracking-widest uppercase rounded flex items-center justify-center transition-all duration-300 transform group-hover:translate-y-[-2px] shadow-xl"
          >
            LET&apos;S PRAY
          </Link>
        </div>
