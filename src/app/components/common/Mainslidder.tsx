...
const pic15 = "https://res.cloudinary.com/dalylashp/image/upload/v1725356882/5954255936203899432_oht64e.jpg"
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen xl:mt-[-10rem] w-screen  2xl:mt-[1rem] md:px-[2rem]  2xl:px-[4rem]">
      ...
      <div
        id="imgnav"
        className=" absolute shadow-xl rounded-md lg:mt-[36rem] xl:mt-[36rem] 2xl:mt-[43rem] z-30 mt-[27rem] md:mt-[36rem] w-[100%] lg:w-[70%] xl:w-[70%] md:w-[70%] mx-auto 2xl:w-3/5   pt-[1.25rem]  lg:pt-[2.125rem] px-[1.25rem] lg:pl-[2.5rem] lg:pr-[1.25rem] md:pb-[2.375rem] lg:pb-[2.375rem] xl:pb-[2.375rem] 2xl:pb-[2.375rem] bg-white   mb-[2.5rem]"
      >
